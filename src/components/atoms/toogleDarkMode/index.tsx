  ...
  return (
    <div>
      <button
        ...
        className="flex items-center gap-2 p-2 rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 text-amber-50 bg-amber-500 focus:ring-amber-600"
      >
        <span
